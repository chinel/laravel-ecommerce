...
@section('breadcrumb')
    <a href="{{url('backstore/deliverytypes')}}">Delivery Types</a> / New Delivery Type
@endsection
...
@section('main-content')
    ...
    <div class="card">
         ...
         <!-- form start -->
             <form role="form" id="product" name="new-product" method="post" action="{{url('backstore/addDeliveryType')}}">
         @csrf
                 <div class="card-body">
<div class="row">
  ...
  <div class="card-body pad">
    <div class="row">
               ...
               <div class="input-group">
                 ...
                 <input type="number" class="form-control" name="fee" required min="0">
...
<div class="col-md-6">
  ...
  <div class="card-body pad">
     <input type="number" min="0" required  name="duration" class="form-control">
   </div>
   </div>
 </div>
   ...
   <div>
     <button type="submit" class="btn btn-info btn-flat btn-lg">SAVE</button>
   </div>
 </div>
 </form>
