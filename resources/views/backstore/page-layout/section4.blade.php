...
@section('main-content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title"><?php echo (empty($section4)) ? "Add" : 'Edit';?>  Home Section 4</h3>
            <?php
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    @if(empty($section4))
                        <form action="{{url('/backstore/addSection4')}}" method="post" role="form" enctype="multipart/form-data">

                            @else
                                <form action="{{url('/backstore/updateSection4')}}" method="post" role="form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category_id" id="category" class="form-control" required>
                                                    ...
                                                    @foreach($categories as $category)
                                                        <option @if(!empty($section4)) @if($section4->category_id == $category->id) selected @endif @endif value="{{$category->id}}" >{{$category->title}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="brandlist[]" id="select1" class="form-control select2" multiple="multiple" data-placeholder="Select..."
                                                    ...
                                                    @if(!empty($section4))
                                                        <?php  $brands = $section4->getCategoryBrands($section4->category_id);?>
                                                        @foreach($brands as $brand)
                                                            <option @if (in_array($brand->id, comma_separated_to_array($section4->brandlist, ","))) selected @endif value="{{$brand->id}}">{{$brand->title}}</option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory1" class="form-control subcategory"
                                                    ...
                                                    @if(!empty($section4))
                                                        <?php $subcategories = $section4->getCategorySubCategories($section4->category_id);?>
                                                        @foreach($subcategories as $subcategory)
                                                            <option @if($section4->subcategory1 == $subcategory->id) selected @endif value="{{$subcategory->id}}">{{$subcategory->title}}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory1_childlist[]" id="select2" class="form-control select2 subcategoryList" multiple="multiple" data-placeholder="Select..."
                                                        style="width: 100%;" required>
                                                    @if(!empty($section4))
                                                        <?php $products = $section4->getSubCategoryProducts($section4->subcategory1);?>
                                                        @foreach($products as $product)
                                                            <option @if (in_array($product->id, comma_separated_to_array($section4->subcategory1_childlist, ","))) selected @endif value="{{$product->id}}">{{$product->title}}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory2" class="form-control subcategory"
                                                    ...
                                                    @if(!empty($section4))
                                                        <?php $subcategories = $section4->getCategorySubCategories($section4->category_id);?>
                                                        @foreach($subcategories as $subcategory)
                                                            <option @if($section4->subcategory2 == $subcategory->id) selected @endif value="{{$subcategory->id}}">{{$subcategory->title}}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory2_childlist[]" id="select3" class="form-control select2 subcategoryList" multiple="multiple" data-placeholder="Select..."
                                                        style="width: 100%;" required>
                                                    @if(!empty($section4))
                                                        <?php $products = $section4->getSubCategoryProducts($section4->subcategory2);?>
                                                        @foreach($products as $product)
                                                            <option @if (in_array($product->id, comma_separated_to_array($section4->subcategory2_childlist, ","))) selected @endif value="{{$product->id}}">{{$product->title}}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory3" class="form-control subcategory"
                                                    ...
                                                    @if(!empty($section4))
                                                        <?php $subcategories = $section4->getCategorySubCategories($section4->category_id);?>
                                                        @foreach($subcategories as $subcategory)
                                                            <option @if($section4->subcategory3 == $subcategory->id) selected @endif value="{{$subcategory->id}}">{{$subcategory->title}}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory3_childlist[]" id="select4" class="form-control select2 subcategoryList" multiple="multiple" data-placeholder="Select..."
                                                        style="width: 100%;" required>
                                                    @if(!empty($section4))
                                                        <?php $products = $section4->getSubCategoryProducts($section4->subcategory3);?>
                                                        @foreach($products as $product)
                                                            <option @if (in_array($product->id, comma_separated_to_array($section4->subcategory3_childlist, ","))) selected @endif value="{{$product->id}}">{{$product->title}}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory4" class="form-control subcategory"
                                                    ...
                                                    @if(!empty($section4))
                                                        <?php $subcategories = $section4->getCategorySubCategories($section4->category_id);?>
                                                        @foreach($subcategories as $subcategory)
                                                            <option @if($section4->subcategory4 == $subcategory->id) selected @endif value="{{$subcategory->id}}">{{$subcategory->title}}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory4_childlist[]" id="select5" class="form-control select2 subcategoryList" multiple="multiple" data-placeholder="Select..."
                                                        style="width: 100%;" required>
                                                    @if(!empty($section4))
                                                        <?php $products = $section4->getSubCategoryProducts($section4->subcategory4);?>
                                                        @foreach($products as $product)
                                                            <option @if (in_array($product->id, comma_separated_to_array($section4->subcategory4_childlist, ","))) selected @endif value="{{$product->id}}">{{$product->title}}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory5" class="form-control subcategory"
                                                    ...
                                                    @if(!empty($section4))
                                                        <?php $subcategories = $section4->getCategorySubCategories($section4->category_id);?>
                                                        @foreach($subcategories as $subcategory)
                                                            <option @if($section4->subcategory5 == $subcategory->id) selected @endif value="{{$subcategory->id}}">{{$subcategory->title}}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="subcategory5_childlist[]" id="select6" class="form-control select2 subcategoryList" multiple="multiple" data-placeholder="Select..."
                                                        style="width: 100%;" required>
                                                    @if(!empty($section4))
                                                        <?php $products = $section4->getSubCategoryProducts($section4->subcategory5);?>
                                                        @foreach($products as $product)
                                                            <option @if (in_array($product->id, comma_separated_to_array($section4->subcategory5_childlist, ","))) selected @endif value="{{$product->id}}">{{$product->title}}</option>
                                                        @endforeach
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="wrap-custom-file" style="width: 600px; height: 300px" >
                                                ...
                                                <label  for="image1" @if(!empty($section4)) class="file-ok" style="background-image: url({{$section4->bannerUrl}});background-size: auto; background-repeat: no-repeat;" @endif>
