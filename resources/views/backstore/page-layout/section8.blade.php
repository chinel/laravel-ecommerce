...
@section('main-content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="card-title"><?php echo (empty($section8)) ? "Add" : 'Edit';?> Section 8</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if(empty($section8))
                        <form action="{{url('/backstore/addSection8')}}" method="post" role="form" enctype="multipart/form-data">

                        @else

                                <form action="{{url('/backstore/updateSection8')}}" method="post" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="wrap-custom-file" style="width: 800px; height: 181px" >
                                                ...
                                                <label  for="image3" @if(!empty($section8)) class="file-ok" style="background-image: url({{$section8->bannerUrl}});background-size: auto; background-repeat: no-repeat;" @endif>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select name="categoryId" class="form-control"
                                                ...
                                                @foreach($categories as $value)
                                                    <option @if(!empty($section8)) @if($section8->categoryId == $value['id']) selected @endif @endif value="{{$value['id']}}">{{$value['title']}}</option>
                                                @endforeach
