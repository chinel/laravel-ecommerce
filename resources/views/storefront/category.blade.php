...
@section('breads')
    ...
    <li class="animate-default title-hover-red"><a href="{{url('/category/'. $productCategory->slug)}}" style="text-transform: capitalize;">{{$productCategory->title}}</a></li>
@endsection
@section('content')
            ...
            <div class="bar-category bottom-margin-default border no-border-r no-border-l no-border-t">
              <div class="row">
                <div class="col-md-5 col-sm-5 col-xs-4">
                  <p class="title-category-page clear-margin" style="text-transform: capitalize;">{{$productCategory->title}}</p>
                </div>
