            ...
            <div class=" container">
                <div class="row">
                    ...
                    <div class="clearfix col-md-3 col-sm-12 col-xs-12 clear-padding social-box text-right">
                        <a href="#"><img src="../storefront/img/social_tw-min.png" alt="Icon Social Twiter"></a>
                        <a href="#"><img src="../storefront/img/social_fa-min.png" alt="Icon Social Facebook"></a>
                        <a href="#"><img src="../storefront/img/social_int-min.png" alt="Icon Social Instagram"></a>
                        <a href="#"><img src="../storefront/img/social_yt-min.png" alt="Icon Social Youtube" /></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class=" container">
                <div class="row">
                    <div class="clearfix col-md-7 clear-padding copyright">
                        <p>Copyright © 2018 Shoprite Pickup Powered by EkoShopper. All Rights Reserved.</p>
                    </div>
                    <div class="clearfix footer-icon-bottom col-md-5 float-right clear-padding">
                        <div class="icon_logo_footer float-right">
                            <img src="../storefront/img/image_payment_footer-min.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
