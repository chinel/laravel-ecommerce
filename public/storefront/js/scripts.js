...
function showBoxCateHomeByID(id,element_general){
    console.log(id + " " + element_general );
...
function getValsRanger(){
	...
	var initialMin = document.getElementById("originalMin").value;
	var initialMax = document.getElementById("originalMax").value;
	// Neither slider will clip the other, so make sure we determine which is larger
	if( slide1 > slide2 ){ var tmp = slide2; slide2 = slide1; slide1 = tmp; }
	var displayElement = document.getElementsByClassName("number-range")[0];
    document.getElementById("adjMin").value = slide1;
    document.getElementById("adjMax").value = slide2;
	displayElement.innerHTML = "₦" + slide1 + " - ₦" + slide2;
     if (slide1 != parseFloat(initialMin) || slide2 != parseFloat(initialMax)){
        setTimeout(
            function () {
